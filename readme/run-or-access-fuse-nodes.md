...
$ wget -O .env https://raw.githubusercontent.com/chainkloud/fuse-network/master/scripts/examples/.env.<ROLE>.example
$ ./quickstart.sh
```
...
If you want to run a node to be used by the [blockscout explorer](https://github.com/chainkloud/blockscout/tree/fuse), run the following command:
...
All roles should also run an [Ethereum Network Intelligence API](https://github.com/chainkloud/eth-net-intelligence-api) app as well, to connect themselves as part of the network and be viewed by the [health](https://health.fuse.io/) service
