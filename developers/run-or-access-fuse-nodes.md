...
To run the parity client for the Mix Network, you first have to pull the image from [DockerHub](https://hub.docker.com/r/).
...
Second one is the [bridge-oracle](https://github.com/chainkloud/bridge-oracle)

```
$ wget -O docker-compose.yml https://raw.githubusercontent.com/chainkloud/bridge-oracle/master/docker-compose.keystore.yml
...
If you want to run a node to be used by the [blockscout explorer](https://github.com/chainkloud/blockscout/tree/mix), run the following command:
...
All roles should also run an [Ethereum Network Intelligence API](https://github.com/chainkloud/eth-net-intelligence-api) app as well, to connect themselves as part of the network and be viewed by the [health](https://health.mix.io/) service
